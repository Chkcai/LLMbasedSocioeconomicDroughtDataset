...
China_Socioeconomic_Drought_Database(2010-2025).xlsx:The socioeconomic drought identification results for 368 prefecture-level cities in China from 2010 to 2025. Includes the identified year, city, supporting webpage links, and manual review results. Due to language limitations on the internet, the supporting webpage links are in Chinese. For the manual review results, 1=TP, 2=
